...
namespace UK.Gov.Legislation.Lawmaker
{
    ...
    public partial class LegislationParser
    {
        ...
        internal IBlock Current() => Input[i];
        ...
        internal IBlock Peek(int num = 1) => Input[i+num];
        ...
        {
            IEnumerable<IBlock> list = Input[i..]
                .Select(block => block)
        ...
        internal bool IsAtEnd() => i > Input.Count;
        private IBlock? Previous() => i > 0 ? Input[i-1] : null;
        ...
        {
            if (Contents[i] is not WLine line)
                return false;
