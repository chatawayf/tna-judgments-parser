...
///
/// </summary>
/// <typeparam name="T">The type being parsed. This might be <c>string</c> if you're parsing a string input or more likely <c>IBlock</c>.</typeparam>
public interface IParser<T>
{
    ...
    delegate R? ParseStrategy<out R>(IParser<T> parser);
